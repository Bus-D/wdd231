...
export async function getAlerts() {
  const alertData = await getJson(`alerts?parkCode=yell`)
...
export async function getActivities(parkCode) {
  const activityData = await getJson(`activities/parks?parkCode=${parkCode}`);
